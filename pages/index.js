    ...
    componentDidMount(){
        document.addEventListener("scroll", () => {
            ...
            for(let i = 0; i < elements.length; i++){
                if(elements[i].offsetTop - window.pageYOffset < window.innerHeight - 100 && !elements[i].classList.contains("show")) {
                    elements[i].classList.add("show");
                }
                else if(elements[i].offsetTop - window.pageYOffset > window.innerHeight - 100 && elements[i].classList.contains("show")){
        ...
        return (
            <div >
                ...
                <section className="section-l section-about">
                    <div>
                        <h3>My tech stack.</h3>
                        <p>Programming languages worked with the most are C++, C# and JavaScript.</p>
